...
class Signup extends React.Component {
  ...
  async signup(term) {
    ...
    if (
      ...
      data.email === null ||
      data.password === null ||
      this.refs.conpass.value == null ||
      this.refs.conpass.value !== data.password
    ) {
      this.refs.errormessage.style.display = "flex";
      this.setState({
        msg: "Fill the details correctly",
          ...
          <div className="password">
            ...
            <div className="input-field">
              <div className="whole-input" style={{ display: "flex" }}>
                ...
                >
                  <VisibilityIcon
                    onClick={this.visibleconon}
                    ref="showconpasson"
                  />
                  <VisibilityOffIcon
                    style={{ display: "none" }}
                    ref="showconpassoff"
                    onClick={this.visibleconoff}
                  />
                </div>
              </div>
              <div className="border"></div>
