...
class Searchbar extends React.Component {
  ...
  searchtext() {
    const URL = `/note/all/${localStorage.getItem("data")}?content=${
  ...
  valuechange(e) {
    const URL = `/note/all/${localStorage.getItem("data")}?month=${
  ...
  valuechange_year(e) {
    const URL = `/note/all/${localStorage.getItem("data")}?year=${
      e.currentTarget.value
    }`;
      ...
      <div className="Searchbar">
        <div>
          <select
            ...
            ref="monthly"
          >
            <option value="Search" style={{ display: "none" }}>
              Month
            </option>
        ...
        <div>
          <select
            onChange={this.valuechange_year}
            style={{ display: "none" }}
            ref="yearly"
          >
            <option value="Search" style={{ display: "none" }}>
